...
```{r, include=FALSE}
game_1 <- plot_player_shots('Victor Wembanyama', 'Spurs', 'Knicks', 2026, 401859963)[[1]]
game_2 <- plot_player_shots('Victor Wembanyama', 'Spurs', 'Knicks', 2026, 401859964)[[1]]
```
...
```{r, echo=FALSE}
plot_player_shots('Victor Wembanyama', 'Spurs', 'Thunder', 2026, 401873197)[[1]]
```
...
*Through cosine similarity – which I wont explain in depth, just know it scores the similarities between vectors with 100 being a perfect match – I was able to match up the proportions at which selected players score (via the [NBAs in depth scoring breakdown](https://www.nba.com/stats/players/drives?Season=2024-25&SeasonType=Regular+Season) stats with data back to 2013) to Wemby. The 6 types of scoring being **drives, catch n shoot, pull ups, post, paint** and **elbow touches**. To be clear this is not measuring quality, just scoring method.*
...
![](./images/brunson.png) ![](./images/giannis.png)
...
You know whose list doesn't make any sort of intuitive sense? I bet you could guess. ![](./images/wemby_current.png)
...
I’ll leave you with 3 players, all compared to Wemby, with both lead scorer and secondary scorer versions of themselves. ![](./images/bench_starter.png)
...
```{r, echo=FALSE}
plot_player_shots('Victor Wembanyama', 'Spurs', 'Knicks', 2026, 401859965)[[1]]
```
...
***S**ome more graphs to prove that it's not just a weird center thing, and a blurb to prove that I swear I'm not trying to say Aaron Gordon and Kyle Filipowski are comparable scorers to Wembanyama.*
...
Jokic and Embiid comparables for 2021 ![](./images/jokic.png) ![](./images/embiid.png) Also a KD graph from when he was 24 and led his team to the finals AFTER leading the league in scoring for the 3 years prior, because I didn't talk about KD enough. Look at how evenly distributed those shots are.

```{r, echo=FALSE}
plot_player_shots('Kevin Durant', 'Thunder', 'Heat', 2012, 320612025)[[1]]
```
